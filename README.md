...
使用 G*Power 计算实验1需要的样本大小，设置（Effect size g=0.2, alpha err prob=0.5, Power=0.8，Constant proportion = 0.5），计算出的Total sample size = 49，由于每个被试需要进行正反两次呈现顺序，即每个被试会对同一个比较对贡献 2 个 Trials。因此，所需被试数为 $49 / 2 = 25$ 人。
